...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="slide caminhão_2.png" alt="First slide">
    </div>
    
    <div class="carousel-item">
      <img class="d-block w-100" src="slide caminhão.png" alt="Second slide">
    </div>

    <div class="carousel-item">
      <img class="d-block w-100" src="slides caminhão_3.png" alt="Third slide">
    </div>
...
$query_products = "SELECT id, name, price, image FROM products  LIMIT 4";
$result_products = $conn->prepare($query_products);
$result_products->execute();
...
$img = str_replace(' ', '',  $str);
        ...
        //echo "<img src='upload/".$result_products->novoNomeDoArquivo."' alt='Foto de exibição' /><br />";
         // echo "ID: $id<br>";
          //echo "Nome: $name<br>";
      ...
      <div class="container_card">
        ...
        <img class="img-fluid" src="upload/<?php echo $img?>">
                <div class="card-body">
                    ...
                    <p class="card-text">R$: <?php echo$price; ?></p>
                  
                    <a href="pages/view-products.php?id=<?php echo $id; ?>" class="btn btn-primary">Detalhes</a>
                </div>
                </div>
</div>
