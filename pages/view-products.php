...
<a class="navbar-brand" href="../index.php"><img id="logo-main" src="../logo_crua.png" class="logo"  width="190" height="190" alt="Logo Thing main logo"></a>
  ...
  <div class="icones">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                <img height="300vh"src="../upload/<?php echo $img?> ">
                </div>
            ...
            <div class="row">
                ...
                <a href="https://api.whatsapp.com/send?phone=5511999753444" target="_blank"class="btn btn-primary">Fale conosco</a>
        ...
        <div class="fixed">
<a href="https://api.whatsapp.com/send?phone=5511999753444"  style="color: black;"target="_blank">
                    <img class='img-fluid' src="../whatsapp.png" style="width: 15vh;">
